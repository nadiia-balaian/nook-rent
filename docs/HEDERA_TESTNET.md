...
settlement. The new local Agent-payment flow requires the pending Member
Session and Agent Payment Mandate migrations plus a fresh explicitly approved
Testnet run before that claim is live.
