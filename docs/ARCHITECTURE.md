...
`nook` schema. Later local migrations add private Member verification and
bounded Agent Payment Mandates. Those later migrations remain pending an
explicit hosted apply.
